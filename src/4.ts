    ...
    updateBoard(board: number[][], num: number, boardIndex: number) {
        for (let i = 0; i < board.length; i++) {
            for (let j = 0; j < board[i].length; j++) {
                if (board[i][j] === num) {
                    this.markedBoards[boardIndex][i][j] = 1;
                    if (this.checkBoard(this.markedBoards[boardIndex])) {
                        console.log(this.markedBoards[boardIndex])
                        return this.scoreBoard(board, this.markedBoards[boardIndex], num);
                    }
                }
            }
        }
